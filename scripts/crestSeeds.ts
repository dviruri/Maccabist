...
export const CREST_SEEDS: readonly CrestSeed[] = [
  ...
  { clubId: 'nottingham_forest', english: 'Nottingham Forest FC', aliases: ['Nottingham Forest', 'Nottingham Forest FC', 'Forest'], country: 'england' },
  ...
  { clubId: 'freiburg', english: 'SC Freiburg', aliases: ['Freiburg'], country: 'germany' },
  ...
  { clubId: 'augsburg', english: 'FC Augsburg', aliases: ['Augsburg'], country: 'germany' },
  { clubId: 'koln', english: '1. FC Köln', aliases: ['1. FC Koln', 'FC Cologne', 'Köln', 'Koln', '1. FC Koeln'], country: 'germany' },
  ...
  { clubId: 'twente', english: 'FC Twente', aliases: ['Twente'], country: 'netherlands' },
  ...
  { clubId: 'fc_groningen', english: 'FC Groningen', aliases: ['Groningen'], country: 'netherlands' },
  { clubId: 'heerenveen', english: 'SC Heerenveen', aliases: ['Heerenveen'], country: 'netherlands' },
  ...
  { clubId: 'sint_truiden', english: 'Sint-Truidense VV', aliases: ['Sint-Truiden', 'STVV', 'Sint-Truiden', 'STVV', 'Sint Truidense'], country: 'belgium' },
  ...
  { clubId: 'union_sg', english: 'Union Saint-Gilloise', aliases: ['Royale Union Saint-Gilloise', 'Union SG', 'Union Saint-Gilloise', 'Union SG', 'Royale Union SG'], country: 'belgium' },
  ...
  { clubId: 'volos', english: 'Volos FC', aliases: ['Volos NFC', 'Volos NFC', 'Volos NPS'], country: 'greece' },
  ...
  { clubId: 'kifisia', english: 'Kifisia FC', aliases: ['AE Kifisia', 'Kifisia'], country: 'greece' },
  ...
  /* ---------------- Cyprus ---------------- */
  { clubId: 'pafos_fc', english: 'Pafos FC', aliases: ['Pafos'], country: 'cyprus' },
  ...
  { clubId: 'nea_salamina', english: 'Nea Salamis Famagusta FC', aliases: ['Nea Salamina', 'Nea Salamis Famagusta', 'Nea Salamis'], country: 'cyprus' },
  ...
  { clubId: 'nacional', english: 'CD Nacional', aliases: ['Nacional da Madeira', 'Nacional de Madeira', 'Nacional Madeira'], country: 'portugal', wikidata: 'Q216459' /* reviewed 2026-08-29: the football club; search also surfaced the sports club */ },
  ...
  { clubId: 'deportivo_la_coruna', english: 'Deportivo de La Coruna', aliases: ['Deportivo La Coruna', 'Deportivo', 'Deportivo La Coruna', 'Deportivo de La Coruna', 'Dep. La Coruna'], country: 'spain' },
  ...
  { clubId: 'willem_ii', english: 'Willem II', aliases: ['Willem II Tilburg', 'Willem II'], country: 'netherlands' },
  ...
  { clubId: 'kalamata', english: 'Kalamata F.C.', aliases: ['PS Kalamata', 'Kalamata', 'PS Kalamata', 'Kalamata FC'], country: 'greece' },
  { clubId: 'karmiotissa', english: 'Karmiotissa FC', aliases: ['Karmiotissa Polemidion', 'Karmiotissa'], country: 'cyprus' },
  { clubId: 'krasava_eny', english: 'Krasava ENY Ypsonas', aliases: ['Krasava', 'ENY Ypsonas', 'Krasava Ypsonas', 'Krasava'], country: 'cyprus' },
