...
const SCENES = [
  ...
  { id: 'gf-matchday', bare: '1', need: ['.gf-md-numbers', '.gf-md-controls', '.gf-btn-primary'] },
  { id: 'gf-matchday-live', bare: '1', need: ['.gf-md-numbers', '.gf-md-now', '.gf-btn-primary'] },
  { id: 'gf-matchday-ft', bare: '1', need: ['.gf-md-numbers', '.gf-md-ft', '.gf-btn-primary'] },
