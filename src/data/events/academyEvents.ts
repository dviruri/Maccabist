    ...
    choices: [
      {
        ...
        outcomes: [
          ...
          },
          {
            ...
            effects: { reputation: 3, coachTrust: -6 },
          },
          {
            id: 'real_deal',
            baseWeight: 15,
        ...
        outcomes: [
          {
            ...
            baseWeight: 55,
            tone: 'good',
            preview: 'תלמד לדבר בחדר ההלבשה, וכל המחלקה תראה אותך אחרת',
          ...
          },
          {
            ...
            baseWeight: 45,
            tone: 'bad',
            preview: 'האחריות תכביד, ובמקום לשחק תתחיל לחשוב יותר מדי',
      ...
      },
      {
        ...
        outcomes: [
          ...
          },
          {
            ...
            baseWeight: 30,
            tone: 'bad',
            preview: 'המאמן ציפה שתקפוץ, והסרט ילך למישהו אחר',
        ...
        outcomes: [
          {
            ...
            baseWeight: 50,
            tone: 'good',
            preview: 'שלושה שבועות מטורפים באימונים, והמאמן לא יוכל להוציא אותך',
          ...
          },
          {
            ...
            baseWeight: 38,
            tone: 'bad',
            preview: 'הוא פשוט טוב יותר העונה, ואתה חוזר לספסל',
          ...
          },
          {
            ...
            baseWeight: 12,
            tone: 'good',
            preview: 'המאמן ימצא דרך לשחק עם שניכם',
        ...
        outcomes: [
          {
            ...
            baseWeight: 65,
            tone: 'bad',
            preview: 'המתח יורגש בחדר ההלבשה, והמאמן יאהב אותך פחות',
          ...
          },
          {
            ...
            baseWeight: 35,
            tone: 'good',
            preview: 'הכעס יוציא ממך משחק של מי שיש לו מה להוכיח',
    ...
    choices: [
      {
        ...
        outcomes: [
          ...
          },
          {
            ...
            baseWeight: 45,
            tone: 'neutral',
            preview: 'משחק סביר - לא תצטיין, לא תיעלם',
        ...
        outcomes: [
          {
            ...
            baseWeight: 70,
            tone: 'good',
            preview: 'משחק נקי וחכם, בדיוק מה שהמאמן רצה לראות',
          ...
          },
          {
            ...
            baseWeight: 30,
            tone: 'neutral',
            preview: 'בלי טעויות, ובלי שום דבר שיזכרו',
        ...
        outcomes: [
          {
            ...
            baseWeight: 45,
            tone: 'good',
            preview: 'ראיון בוגר - תישמע כמו מישהו שאפשר לבנות עליו',
            text: 'ראיון בוגר וממוקד. אתה נשמע כמו מישהו שאפשר לבנות עליו.',
            effects: { reputation: 9, coachTrust: 2, pressure: 5 },
          ...
          },
          {
            ...
            baseWeight: 55,
            tone: 'bad',
            preview: 'משפט אחד ייצא מהקשרו ויהפוך לכותרת',
        ...
        outcomes: [
          {
            ...
            baseWeight: 40,
            tone: 'good',
            preview: 'תישאר, ובינואר תיפתח לך דלת בבוגרים',
          ...
          },
          {
            ...
            baseWeight: 60,
            tone: 'bad',
            preview: 'עוד חצי עונה של חימומים וכניסות בדקה 85',
        ...
        outcomes: [
          {
            ...
            baseWeight: 45,
            tone: 'good',
            preview: 'חוזה ארוך ותנאים מצוינים',
          ...
          },
          {
            ...
            baseWeight: 55,
            tone: 'bad',
            preview: 'המשא ומתן יימשך חודשיים, והמאמן יוריד אותך לספסל',
        ...
        outcomes: [
          {
            ...
            baseWeight: 55,
            tone: 'good',
            preview: '90 דקות מהטובים במגרש, והטלפון של הסוכן יתחיל לצלצל',
          ...
          },
          {
            ...
            baseWeight: 30,
            tone: 'neutral',
            preview: 'תשב רוב הזמן - אבל תהיה שם',
          ...
          },
          {
            ...
            baseWeight: 15,
            tone: 'bad',
            preview: 'מכה בנבחרת, וחזרה למועדון צולע',
