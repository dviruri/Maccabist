      ...
      },
      {
        ...
        outcomes: [
          ...
          },
          {
            ...
            baseWeight: 42,
            tone: 'neutral',
            preview: 'הוא יבעט לידיים, ואף אחד לא ידבר עליך',
        ...
        outcomes: [
          {
            ...
            baseWeight: 42,
            tone: 'good',
            preview: 'שיחה קשה ואמיתית, ואתה חוזר להרכב',
          ...
          },
          {
            ...
            baseWeight: 58,
            tone: 'bad',
            preview: 'הוא לא אוהב את הטון - עכשיו אתה גם בחוץ וגם מסומן',
        ...
        outcomes: [
          {
            ...
            baseWeight: 58,
            tone: 'good',
            preview: 'שלושה חודשי אימונים שאי אפשר להתעלם מהם',
          ...
          },
          {
            ...
            baseWeight: 42,
            tone: 'bad',
            preview: 'תעבוד כמו חיה וחצי עונה עדיין תלך',
    ...
    choices: [
      {
        ...
        outcomes: [
          ...
          },
          {
            ...
            baseWeight: 40,
            tone: 'bad',
            preview: 'השוער ינחש, והשקט באצטדיון יהיה רועש מכל דבר',
        ...
        outcomes: [
          {
            ...
            baseWeight: 52,
            tone: 'good',
            preview: 'תעלה רמה כדי לא לוותר על המקום',
          ...
          },
          {
            ...
            baseWeight: 48,
            tone: 'bad',
            preview: 'הלחץ שלך יורגש, והוא דווקא יפרח',
        ...
        outcomes: [
          {
            ...
            baseWeight: 42,
            tone: 'good',
            preview: 'פציעה שלו, הזדמנות שלך, ושני חודשים מצוינים',
        ...
        outcomes: [
          {
            ...
            baseWeight: 48,
            tone: 'good',
            preview: 'הופעת ענק - ואירופה תדע את השם שלך',
          ...
          },
          {
            ...
            baseWeight: 52,
            tone: 'bad',
            preview: 'הקצב יהיה גבוה מדי, ותוחלף בהפסקה',
        ...
        outcomes: [
          {
            ...
            baseWeight: 65,
            tone: 'bad',
            preview: 'מישהו יצלם אותך נוסע, וזה לא ייראה טוב למחרת',
      ...
      },
      {
        ...
        outcomes: [
          ...
          },
          {
            ...
            baseWeight: 58,
            tone: 'bad',
            preview: 'הגוף לא יענה, ועונה של חצאי כניסות',
        ...
        outcomes: [
          {
            ...
            baseWeight: 34,
            tone: 'good',
            preview: 'שער, בישול, וכל מי שצופה רושם את השם שלך',
          ...
          },
          {
            ...
            baseWeight: 48,
            tone: 'neutral',
            preview: 'בלי דקות, אבל עם ההמנון בחולצת הנבחרת',
            text: 'לא שיחקת דקה, אבל שרת את ההמנון בחולצה של הנבחרת. יש דברים ששווים גם בלי דקות.',
            effects: { reputation: 5, confidence: 4 },
          },
          {
            id: 'injured_there',
            baseWeight: 18,
            tone: 'bad',
            preview: 'פציעה באימון הנבחרת, וחזרה עם קביים',
        ...
        outcomes: [
          {
            ...
            baseWeight: 40,
            tone: 'good',
            preview: 'הפריסיזן הטוב בחייך, והוא זה שנכנס במקומך',
          ...
          },
          {
            ...
            baseWeight: 37,
            tone: 'neutral',
            preview: 'שניכם משחקים - לא הרכב ולא ספסל',
          ...
          },
          {
            ...
            baseWeight: 23,
            tone: 'bad',
            preview: 'הוא פשוט טוב יותר, והספסל מפסיק להיות זמני',
        ...
        outcomes: [
          {
            ...
            effects: { roleValue: 3, coachTrust: 5, reputation: 2, discipline: 4 },
          },
        ],
      },
    ],
        ...
        outcomes: [
          {
            ...
            baseWeight: 62,
            tone: 'neutral',
            preview: 'פחות אחריות, פחות עיניים - וראש נקי למשחק',
          ...
          },
          {
            ...
            baseWeight: 38,
            tone: 'bad',
            preview: 'בחדר ההלבשה ישימו לב, ולא יחזירו לך כשתצטרך',
        ...
        outcomes: [
          {
            ...
            baseWeight: 40,
            tone: 'good',
            preview: 'הם מכבדים את זה ומשפרים - חוזה של שחקן מוביל',
          ...
          },
          {
            ...
            baseWeight: 60,
            tone: 'bad',
            preview: 'המו״מ נתקע ודולף לעיתונות, והיציע לא אוהב לקרוא על כסף',
        ...
        outcomes: [
          {
            ...
            baseWeight: 36,
            tone: 'good',
            preview: 'היציע יאמץ את זה - סוף סוף מישהו אמר בקול',
            text: 'היציע מאמץ את זה. סוף סוף מישהו אמר בקול מה שכולם חשבו.',
            effects: { reputation: 7, roleValue: 5, flags: ['fan_favourite'] },
            modifiers: [
          ...
          },
          {
            ...
            baseWeight: 64,
            tone: 'bad',
            preview: 'חלק מהקבוצה יפסיק לדבר איתך, והמאמן יראה בזה אתגר לסמכות',
        ...
        outcomes: [
          {
            ...
            baseWeight: 52,
            tone: 'good',
            preview: 'דו-קרב אחד, ואתה שחקן שוב ולא פצוע שמתאמן',
          ...
          },
          {
            ...
            baseWeight: 48,
            tone: 'bad',
            preview: 'אותו מקום, אותו כאב - והפעם בלי תאריך',
        ...
        outcomes: [
          {
            ...
            baseWeight: 38,
            tone: 'good',
            preview: 'תכריע את הגמר ולא תיגע בדשא בכלל',
        ...
        outcomes: [
          {
            ...
            baseWeight: 40,
            tone: 'neutral',
            preview: 'הכעס יעבוד לטובתך - חצי עונה מהטובות שלך',
          ...
          },
          {
            ...
            baseWeight: 60,
            tone: 'bad',
            preview: 'זה ייראה בכל אימון, והמאמן יפסיק לסמוך עליך',
