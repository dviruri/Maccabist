        ...
        outcomes: [
          {
            ...
            baseWeight: 42,
            tone: 'good',
            preview: 'תיכנס בקפטן בדו-קרב ולא תתנצל - והוא יחייך',
          ...
          },
          {
            ...
            baseWeight: 58,
            tone: 'bad',
            preview: 'כניסה חזקה מדי בוותיק - וחדר ההלבשה לא אוהב את זה מבן 18',
        ...
        outcomes: [
          {
            ...
            baseWeight: 46,
            tone: 'good',
            preview: 'דקה 79, השם שלך, ושבע דקות שתזכור',
          ...
          },
          {
            ...
            baseWeight: 54,
            tone: 'neutral',
            preview: 'שלושה חימומים וחזרה לשבת',
        ...
        outcomes: [
          {
            ...
            baseWeight: 38,
            tone: 'good',
            preview: 'תשחק בלי פחד, והיציע יקרא את השם שלך בדקה 70',
          ...
          },
          {
            ...
            baseWeight: 40,
            tone: 'neutral',
            preview: 'לא תבלוט ולא תיפול - בדיוק מה שצריך כדי לקבל משחק שני',
          ...
          },
          {
            ...
            baseWeight: 22,
            tone: 'bad',
            preview: 'הקצב יהיה אחר לגמרי, ותוחלף בהפסקה',
        ...
        outcomes: [
          {
            ...
            baseWeight: 34,
            tone: 'neutral',
            preview: 'תעשה את זה בדרך שלך וזה יעבוד - והוא לא ייגש שוב',
          ...
          },
          {
            ...
            baseWeight: 66,
            tone: 'bad',
            preview: 'תטעה, הוא יצדק, וכולם יראו',
        ...
        outcomes: [
          {
            ...
            baseWeight: 52,
            tone: 'neutral',
            preview: 'אוטו, ערב עם החברים, וחזרה לאימון בזמן',
        ...
        outcomes: [
          {
            ...
            baseWeight: 55,
            tone: 'good',
            preview: 'עשר דקות שבהן תגיד בדיוק מה אתה יכול לתת',
          ...
          },
          {
            ...
            baseWeight: 45,
            tone: 'bad',
            preview: 'מנומס ולא יותר - ותוך חודש יביא שחקן לעמדה שלך',
        ...
        outcomes: [
          {
            ...
            baseWeight: 52,
            tone: 'good',
            preview: 'תלמד תפקיד חדש ותצא ממנו שחקן שלם יותר',
          ...
          },
          {
            ...
            baseWeight: 48,
            tone: 'bad',
            preview: 'תעשה בדיוק מה שביקשו ותרגיש בינוני',
        ...
        outcomes: [
          {
            ...
            baseWeight: 36,
            tone: 'good',
            preview: 'המאמן מקשיב ומזיז מישהו אחר',
        ...
        outcomes: [
          {
            ...
            baseWeight: 42,
            tone: 'good',
            preview: 'ערב שנכנס לתולדות המועדון, ואתה בתוכו',
          ...
          },
          {
            ...
            baseWeight: 58,
            tone: 'bad',
            preview: 'אצטדיון מלא שיוצא בשקט - הצליל הכי כבד שיש',
        ...
        outcomes: [
          {
            ...
            baseWeight: 52,
            tone: 'good',
            preview: 'העבודה הנוספת מחזירה את הביטחון תוך שבועיים',
          ...
          },
          {
            ...
            baseWeight: 48,
            tone: 'bad',
            preview: 'ככל שתעבוד יותר תשחק מתוח יותר',
        ...
        outcomes: [
          {
            ...
            baseWeight: 58,
            tone: 'good',
            preview: 'סופ״ש בלי כדורגל, וחוזרים כשזה נראה פשוט יותר',
          ...
          },
          {
            ...
            baseWeight: 42,
            tone: 'bad',
            preview: 'תחזור רענן בראש ואיטי ברגליים',
        ...
        outcomes: [
          {
            ...
            baseWeight: 50,
            tone: 'good',
            preview: 'שלושה משחקים, ואותו יציע שר את שמך',
          ...
          },
          {
            ...
            baseWeight: 50,
            tone: 'bad',
            preview: 'תתחיל לשחק כדי לא לטעות - וזה בדיוק מה שגורם לטעויות',
    ...
    choices: [
      {
        ...
        outcomes: [
          ...
          },
          {
            ...
            baseWeight: 52,
            tone: 'bad',
            preview: 'תדבר, ואף אחד לא ירים את הראש',
        ...
        outcomes: [
          {
            ...
            baseWeight: 45,
            tone: 'good',
            preview: 'שלושה משחקים כהכי טוב על הדשא - והאליפות תיקשר לשמך',
          ...
          },
          {
            ...
            baseWeight: 55,
            tone: 'bad',
            preview: 'המשקל יהיה כבד מדי, ותפסידו בשתי נקודות',
        ...
        outcomes: [
          {
            ...
            baseWeight: 36,
            tone: 'good',
            preview: 'פריסיזן של בן 24, ועוד עונה בהרכב',
          ...
          },
          {
            ...
            baseWeight: 64,
            tone: 'bad',
            preview: 'הגוף עונה במקומך, וההחלטה מתקבלת בלעדיך',
        ...
        outcomes: [
          {
            ...
            baseWeight: 45,
            tone: 'good',
            preview: 'עוד עונה עם הסרט, והוא יקבל את זה',
          ...
          },
          {
            ...
            baseWeight: 55,
            tone: 'bad',
            preview: 'הכותרת תצא "עדיין של מכבי", והמאמן יקרא אותך לשיחה',
        ...
        outcomes: [
          {
            ...
            baseWeight: 44,
            tone: 'neutral',
            preview: 'יש מי שמוכן לתת שנתיים ודקות',
          ...
          },
          {
            ...
            baseWeight: 56,
            tone: 'bad',
            preview: 'הסוכן חוזר בידיים ריקות, ותגלה כמה שווה בן 34',
        ...
        outcomes: [
          {
            ...
            baseWeight: 44,
            tone: 'good',
            preview: 'תשעים דקות שבהן תשכח בן כמה אתה, וכל האצטדיון יעמוד',
          ...
          },
          {
            ...
            baseWeight: 56,
            tone: 'neutral',
            preview: 'הרצון יהיה שם, הרגליים פחות - והאצטדיון יקום בכל זאת',
